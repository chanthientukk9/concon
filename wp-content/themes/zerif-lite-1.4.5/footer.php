...
<footer id="footer" itemscope="itemscope" itemtype="http://schema.org/WPFooter">
	...
	<div class="container">
		...
		<?php
			...
			!empty($zerif_copyright) || !empty($zerif_socials_instagram) ):
						...
						echo '<div class="'.$footer_class.' copyright" style="padding-bottom:10px;">';
						if(!empty($zerif_socials_facebook) || !empty($zerif_socials_twitter) || !empty($zerif_socials_linkedin) || !empty($zerif_socials_behance) || !empty($zerif_socials_dribbble)):
							echo '<ul class="social">';

							/* facebook */
							if( !empty($zerif_socials_facebook) ):
								echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_facebook).'"><i class="fa fa-facebook fa-2x"></i></a></li>';
							endif;
							/* twitter */
							if( !empty($zerif_socials_twitter) ):
								echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_twitter).'"><i class="fa fa-twitter fa-2x"></i></a></li>';
							endif;
							/* linkedin */
							if( !empty($zerif_socials_linkedin) ):
								echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_linkedin).'"><i class="fa fa-youtube fa-2x"></i></a></li>';
							endif;
							/* behance */
							...
							if( !empty($zerif_socials_instagram) ):
								echo '<li><a'.$attribut_new_tab.' href="'.esc_url($zerif_socials_instagram).'"><i class="fa fa-instagram fa-2x"></i></a></li>';
							endif;
							echo '</ul>';
						endif;
	...
	<!-- INFO LINKCARE FOOTER -->
	<!-- table class="tab-footer">
		<tr>
			
			<td class="tab-footer-title"> LỢI ÍCH </td>
			<td class="tab-footer-title"> HỖ TRỢ </td>
			<td class="tab-footer-title"> CÔNG TY </td>
		</tr>
		<tr>
			
			<td class="tab-footer-text"><a href="partners"> Đối Tác </a>
			</br><a href="users">Người Dùng</a>
			</td>
			<td class="tab-footer-text"><a href="privacypolicy"> Chính Sách Riêng Tư</a>
			</br><a href="/2016/"> Tin Tức </a>
			</td>
			<td class="tab-footer-text"><a href="aboutconcon"> Concon </a></td>
		</tr>
	</table -->
	<!-- [END] INFO LINKCARE FOOTER -->
	</div> <!-- / END CONTAINER -->
