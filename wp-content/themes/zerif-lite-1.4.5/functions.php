			...
			<?php if( !empty($instance['image_uri']) && ($instance['image_uri'] != 'Upload Image') ) { ?>
				...
				<div class="service-icon">
					...
					<?php if( !empty($instance['link']) ) { ?>
						...
						<a href="<?php echo esc_url($instance['link']); ?>"><i class="pixeden" style="background:url(<?php echo esc_url($instance['image_uri']); ?>) no-repeat center;width:100%; height:100%;" onmouseover=this.style.backgroundImage="url(<?php echo str_replace('.png','_hover.png', esc_url($instance['image_uri'])); ?>)"; onmouseout=this.style.backgroundImage="url(<?php echo esc_url($instance['image_uri']); ?>)";></i> <!-- FOCUS ICON--></a>
